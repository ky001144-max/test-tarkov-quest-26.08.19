      ...
      quest.objectives.forEach(obj => {
        if (obj.map_id === this.currentMapMeta.id && obj.position) {
          ...
          const customIcon = L.divIcon({
            ...
            html: `
              <div class="leaflet-quest-marker" id="marker-obj-${obj.id}">
                <div class="leaflet-marker-inner">
                  <i class="${iconClass}"></i>
                </div>
                <div class="leaflet-marker-tip"></div>
              </div>
            `,
            iconSize: [28, 36],
            iconAnchor: [14, 36],
          ...
          const hintHtml = obj.hint ? `<div style="color: var(--accent-cyan); font-weight: 600; margin-top: 4px; font-size: 11px;"><i class="fa-solid fa-compass"></i> 위치 힌트: ${obj.hint}</div>` : '';
